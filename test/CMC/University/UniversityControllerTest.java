...
//AddUniversityTest
	   ...
	   public void testVerSATLessThan200(){
	    UniversityController.addUniversity("Test", "MN", "Urban", "private", "100", "10", "199", "200", "1", "1", "1", "0", "0", "1", "1", "1", emp, true);
	   }
	   ...
	   public void testQOAScaleGreaterThan5(){
	    UniversityController.addUniversity("Test", "MN", "Urban", "private", "100", "10", "200", "200", "1", "1", "1", "0", "0", "1", "1", "6", emp, true);
	   }
...
//EditUniversityTest
	   ...
	   public void testEditVerSATLessThan200(){
	    UniversityController.editUniversityinfo("Test", "MN", "Urban", "private", "100", "10", "199", "200", "1", "1", "1", "0", "0", "1", "1", "1", emp, true);
	   }
